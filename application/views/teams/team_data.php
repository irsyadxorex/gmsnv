        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="<?= base_url('team/add'); ?>" class="btn btn-primary pull-right"><i class="fa fa-user-plus"></i> Tambah</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="listTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="100px">Position</th>
                        ...
                        <tbody>
                            ...
                            foreach ($users as $user) : ?>
                                <tr>
                                    ...
                                    <td><?= $user['username']; ?></td>
                                    <?php if ($this->session->userdata('id_site') == 0) : ?>
                                        <td class="text-center"><?= $user['site']; ?></td>
                                    <?php endif ?>
                                    <td class="text-center"><?= $user['jenis_kelamin'] == 1 ? 'L' : 'P'; ?></td>
                                    <td class=""><?= $user['position']; ?></td>
                                    <td class=""><?= $user['status'] == 1 ? '<span class="label label-success">aktif</span>' : '<span class="label label-default">tidak aktif</span>'; ?></td>
                                    <td class="text-center">
                                        <form action="<?= base_url('user/delete'); ?>" method="post">
                                            <a href="<?= base_url('team/edit/') . $user['username']; ?>" class="label label-info"><i class="fa fa-eye"></i> View</a>
