            ...
            <div class="col-xs-6">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Detail Team </h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group <?= form_error('name') ? 'has-error' : ''; ?>">
                                    ...
                                    <input type="text" class="form-control" value="<?= set_value('nama'); ?>" id="nama" name="nama" autofocus autocomplete="off">
                                </div>
                                <div class="form-group <?= form_error('identitas') ? 'has-error' : ''; ?>">
                                    <label for="identitas">No Identitas/NIK * </label>
                                    <input type="number" class="form-control" value="" id="identitas" name="identitas">
                                </div>
                                ...
                                <div class="form-group <?= form_error('telephone') ? 'has-error' : ''; ?>">
                                    ...
                                    <input type="number" class="form-control" value="" id="telephone" name="telephone">
                                </div>
                                ...
                                <div class="form-group <?= form_error('tempat_lahir') ? 'has-error' : ''; ?>">
                                    ...
                                    <input type="text" class="form-control" value="" id="tempat_lahir" name="tempat_lahir">
                                </div>
                                <div class="form-group <?= form_error('tanggal_lahir') ? 'has-error' : ''; ?>">
                                    <label for="tanggal_lahir">Tanggal Lahir </label>
                                    <input type="date" class="form-control" value="" id="tanggal_lahir" name="tanggal_lahir">
                                </div>

                                <div class="form-group <?= form_error('alamat') ? 'has-error' : ''; ?>">
                                    <label for="alamat">Alamat </label>
                                    <textarea type="date" class="form-control" id="alamat" name="alamat"></textarea>
                                </div>
                                <div class="form-group <?= form_error('tmt') ? 'has-error' : ''; ?>">
                                    <label for="tmt">Tanggal Masuk </label>
                                    <input type="date" class="form-control" value="" id="tmt" name="tmt">
                                </div>
                                <div class="form-group <?= form_error('resign') ? 'has-error' : ''; ?>">
                                    <label for="resign">Tanggal Resign </label>
                                    <input type="date" class="form-control" value="" id="resign" name="resign">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group <?= form_error('position') ? 'has-error' : ''; ?>">
                                    ...
                                    <select class="form-control" id="position" name="position">
                                        ...
                                        <option value="1">Anggota Security</option>
                                        <option value="2">Komandan Regu</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
